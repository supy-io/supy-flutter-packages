...
class ShippingOptions {
  ...
  ShippingMethod? getCheapestMethod() {
    ...
    return availableMethods!.reduce(
        (current, next) => current.baseCost < next.baseCost ? current : next,);
  }
  ...
  ShippingOptions copyWith({
    ...
    return ShippingOptions(
      ...
      allowMethodSelection: allowMethodSelection ?? this.allowMethodSelection,
  ...
  @override
  String toString() {
    return 'ShippingOptions(methods: ${availableMethods?.length ?? 0}, '
        'selected: $selectedMethodId, freeThreshold: $freeShippingThreshold)';
  }
}
