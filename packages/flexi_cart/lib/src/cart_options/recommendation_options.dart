...
//     return DateTime.now()
//     .difference(timestamp).inMinutes > expirationMinutes;
//   }
// }
//
...
//   final bool Function(ICartItem product, FlexiCart cart)?
...
//         recommendations.
//         addAll(_getRecommendationsByStrategy(strategy, cart));
//       }
//
...
//   List<ICartItem>
//   _getFrequentlyBoughtTogetherRecommendations(FlexiCart cart) {
...
//       priceRangeCalculator: priceRangeCalculator ??
//       this.priceRangeCalculator,
//     );
//   }
// }
