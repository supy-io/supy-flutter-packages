import 'cart/cart_test.dart' as cart_test;
...
import 'flexi_cart_test.dart' as flexi_cart_test;
import 'flexi_cart_theme_test.dart' as flexi_cart_theme_test;

void main() {
  flexi_cart_test.main();
  cart_test.main();
  input_test.main();
  formatter_test.main();
  mixins_test.main();
  flexi_cart_diff_test.main();
  flexi_cart_theme_test.main();
}
